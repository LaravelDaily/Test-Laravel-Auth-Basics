...
// Task: profile functionality should be available only for logged-in users - DONE!
...
// Add some middleware here, and change some code in app/Models/User.php to enable this - DONE!
...
// You need to add some middleware here - DONE!
