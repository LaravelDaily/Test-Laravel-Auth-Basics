...
Route::view('/secretpage', 'secretpage')
    ->name('secretpage')->middleware(\App\Http\Middleware\RedirectIfNotVieryfied::class);
...
Route::view('/verysecretpage', 'verysecretpage')
    ->name('verysecretpage')->middleware(\App\Http\Middleware\RedirectIfNotConfirmPassword::class);
