...
// Task 5: this "/secretpage" URL should be visible only for those who VERIFIED their email
...
// Task 6: this "/verysecretpage" URL should ask user for verifying their password once again
