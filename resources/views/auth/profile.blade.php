                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-input id="name" class="block w-full mt-1" type="text" name="name" value="{{ Auth::user()->name }}" required />
                        </div>

                        <div class="mt-4">
                            <x-label for="email" :value="__('Email')" />

                            <x-input id="email" class="block w-full mt-1" type="email" name="email" value="{{ Auth::user()->email }}" required />
                        </div>
